...
//                list = (from cba in kaucjaDbContext.PlatformBankAccount
//                        select new Bank()
//                        {
//                            Name = cba.BankName
//                        }).AsNoTracking().Distinct().OrderBy(cba => cba.Name).ToList();
//
...
//
//                //Zapisujemy wyjątek.
//                LogHelper.SaveException(DateTime.Now, "Payment", "GetBank()", ex.Message);
//            }
//
//            //Zwracamy dane.
//            return Json(list);
...
//
//                //Zapisujemy wyjątek.
//                LogHelper.SaveException(DateTime.Now, "Payment", "GetCurrency()", ex.Message);
//            }
//
//            //Zwracamy dane.
//            return Json(list);
