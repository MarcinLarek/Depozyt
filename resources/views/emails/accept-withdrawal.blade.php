...
<body>
    <table>
        ...
        <tr>
            <td colspan="2">
                Nowe zlecenie wypłaty na platformie!
            </td>
        </tr>
        <tr>
            <td colspan="2">
                Dnia {Date}, zostało zlecone wypłacenie środków z platformy:
            </td>
        </tr>
        <tr style="height: 20px">
            <td></td>
        ...
        <tr>
            <td class="font-weight-bold" colspan="2" style="background: #fafafa;">Szczegóły wypłaty</td>
        </tr>
        <tr>
            <td class="font-weight-bold text-right">Bank:</td>
        ...
        <tr>
            <td colspan="2">
                Kliknij <a href="{AcceptWithdrawalLink}"> tutaj</a>, aby zaakceptować wypłatę środków.
            </td>
        </tr>
        <tr style="height: 20px">
            <td></td>
