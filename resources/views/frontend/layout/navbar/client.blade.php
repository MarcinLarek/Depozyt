            ...
            <ul class="navbar-nav flex-grow-1 ml-md-auto">
                <li class="nav-item dropdown ml-md-auto">
                    <a class="nav-link dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true"
                       href="#" data-toggle="dropdown">{{ __('navbar.resources') }}</a>
                    <div class="dropdown-menu"
                         style="left: 0; top: 0; position: absolute; transform: translate3d(0, 38px, 0);"
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true"
                       href="#" data-toggle="dropdown">{{ __('navbar.settings') }}</a>
                    <div class="dropdown-menu"
                         style="left: 0px; top: 0px; position: absolute; transform: translate3d(0px, 38px, 0px);"
                         x-placement="bottom-start">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true"
                       href="#" data-toggle="dropdown">{{ __('navbar.language') }}</a>
