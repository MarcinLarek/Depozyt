    ...
    <div class="navbar-collapse collapse d-sm-inline-flex mt-auto">
      ...
      <ul class="navbar-nav flex-grow-1 ml-md-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true" href="#" data-toggle="dropdown">Użytkownicy</a>
          <div class="dropdown-menu" style="left: 0; top: 0; position: absolute; transform: translate3d(0px, 38px, 0px);" x-placement="bottom-start">
            <a class="dropdown-item" href="{{ route('admin.users') }}">Klienci</a>
            <a class="dropdown-item" href="{{ route('admin.admins') }}">Administratorzy</a>
          </div>
        </li>
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle" role="button" aria-expanded="false" aria-haspopup="true" href="#" data-toggle="dropdown">Platforma</a>
          <div class="dropdown-menu" style="left: 0; top: 0; position: absolute; transform: translate3d(0px, 38px, 0px);" x-placement="bottom-start">
