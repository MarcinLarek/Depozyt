          ...
          <fieldset>
            ...
            <div class="row">
              <div class="form-group col-md-12">
                <label for="account-number" class="control-label">{{ __('recipient.EDI-account_number') }}</label>
                ...
                <div class="input-group mb-2">
                  ...
                  <input name="account_number" id="account-number" class="form-control" placeholder="Nr konta" value="{{ old('account_number') }}" />
                </div>
          ...
          <fieldset>
            ...
            <div class="row">
              ...
              <div class="form-group col-md-4">
                ...
                <input name="post_code" id="post-code" class="form-control" placeholder="{{ __('recipient.EDI-postcode') }}" value="{{ old('post_code') }}" />
