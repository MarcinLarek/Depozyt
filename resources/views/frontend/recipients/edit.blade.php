                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="name" id="name" class="form-control" placeholder="{{ __('recipient.EDI-recipient_name') }}"
                                           value="{{ old('name', $recipient->name) }}"/>
                                    <span asp-validation-for="Name" class="text-danger"></span>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="nip" class="control-label">{{ __('recipient.EDI-nip') }}</label>
                                    <input name="nip" id="nip" class="form-control" placeholder="{{ __('recipient.EDI-nip') }}"
                                           value="{{ old('name', $recipient->nip) }}"/>
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="email" id="email" class="form-control" placeholder="{{ __('recipient.EDI-email') }}"
                                           value="{{ old('email', $recipient->email) }}"/>
                                    <span asp-validation-for="Email" class="text-danger"></span>
                                </div>
                                <div class="form-group col-md-6">
                                    <label for="phone" class="control-label">{{ __('recipient.EDI-telephone') }}</label>
                                    <input name="phone" id="phone" class="form-control" placeholder="{{ __('recipient.EDI-telephone') }}"
                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="street" id="street" class="form-control" placeholder="{{ __('recipient.EDI-street') }}"
                                           value="{{ old('street', $recipient->street) }}"/>
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="post_code" id="post-code" class="form-control"
                                           placeholder="{{ __('recipient.EDI-postcode') }}"
                                           value="{{ old('post_code', $recipient->getPostCode()) }}"/>
                                    <span asp-validation-for="PostCode" class="text-danger"></span>
                                </div>
                                <div class="form-group col-md-4">
                                    <label for="city" class="control-label">{{ __('recipient.EDI-city') }}</label>
                                    <input name="city" id="city" class="form-control" placeholder="{{ __('recipient.EDI-city') }}"
                                           value="{{ old('city', $recipient->getCity()) }}"/>
                        ...
                        <div class="row">
                            <div class="form-group col-md-12">
                                ...
                                <a class="alert-link" data-toggle="modal" href="#myModal2">
                                    <img class="ml-2" src="{{ asset('/images/info.svg') }}"
                                         title="{{ __('recipient.EDI-POP-activate-title') }}"/>
                                </a>
