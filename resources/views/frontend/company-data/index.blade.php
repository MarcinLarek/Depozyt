                        ...
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <input name="phone_number" id="phone-number" class="form-control"
                                           placeholder="{{ __('company.COM-telephone') }}"  value="{{ old('phone_number', $companyData->phone_number) }}" />
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input name="post_code" id="post-code" class="form-control"
                                           placeholder="{{ __('company.COM-postcode') }}"  value="{{ old('name', $companyData->post_code) }}" />
                                </div>
                                <div class="form-group col-md-4">
