...
<article class="backgroud-europe" style="background-image:url({{url('/images/background-europe2.jpg')}}); background-size: cover; backgroud-opacity: 0.5;">
  ...
  <div class="content">
    ...
    <div class="row my-4">
      ...
      <a href="{{ route('how-it-works') }}" class="mx-auto"><button type="button" class="btn btn-outline-primary"
          style="font-size:40px; margin-top:30px;margin-bottom:30px;border-radius: 50px;border-width:2px; ">{{ __('home.learnmore') }}</button></a>
