        ...
        <form id="list-filter" method="post">
          <div class="row">
            ...
            <div class="form-group col-md-3">
              ...
              <input name="from_date" id="from-date" class="form-control" placeholder="{{ __('transaction.IND-fromdate') }}" readonly="readonly" type="text" />
            </div>
            <div class="form-group col-md-3">
              <label for="to-date" class="control-label"></label>
              <input name="to_date" id="to-date" class="form-control" placeholder="{{ __('transaction.IND-todate') }}" readonly="readonly" type="text" />
            </div>
            <div class="form-group col-md-3">
